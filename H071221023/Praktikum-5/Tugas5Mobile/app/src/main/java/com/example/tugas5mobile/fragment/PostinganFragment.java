    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btn_posting.setOnClickListener(btn ->{
            ...
            if (konten.isEmpty()) {
                ...
                Instagram instagram = new Instagram("Trisman Tegar Wiratama", "Trisman", konten, R.drawable.me, selectedImageUri);

                Bundle bundle = new Bundle();
                bundle.putParcelable(com.example.tugas5mobile.fragment.HomeFragment.EXTRA_INSTAGRAM, instagram);

                com.example.tugas5mobile.fragment.HomeFragment homeFragment = new com.example.tugas5mobile.fragment.HomeFragment();

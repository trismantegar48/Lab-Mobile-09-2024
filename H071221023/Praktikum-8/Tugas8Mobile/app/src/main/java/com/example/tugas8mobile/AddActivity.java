    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_submit.setOnClickListener(v -> {
            ...
            if (judul.isEmpty() ) {
                ...
                dbConfig.insertData(judul, deskripsi);  //Menyisipkan catatan baru dengan judul dan deskripsi yang ditentukan ke dalam basis data
                // Menampilkan pesan singkat kepada pengguna
